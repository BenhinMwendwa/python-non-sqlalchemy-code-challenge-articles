    ...
    def title(self, title):
       if hasattr(self,"title"): 
        ...
        if isinstance(title,str) and 5<=len(title)<=50:
            ...
            ValueError("Title must be a string and  between 5 and 50 characters")
...
class Magazine:
    ...
    def contributing_authors(self):
      authors = {}# create an empty string
...
author1 = Author("Johnson startt")
author2 = Author("OKOLA OJwan")
author3 = Author("Benhin Mwendwa")
magazine1 = Magazine("Forbes", "Science")
magazine2 = Magazine("Todays Tech", "Technology")
author1.add_article(magazine1, "The Future of Deep sea Exploration")
author1.add_article(magazine2, "Advancements in Cancer Treatment")
author2.add_article(magazine1, "The Latest Discoveries in Physics")
